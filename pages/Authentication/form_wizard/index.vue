...
export default {
  ...
  data() {
    return {
      ...
      bio: "",
      bioError: "",
      players: [],  // Массив для хранения игроков
    };
  },
  methods: {
    ...
    onTabBeforeChange() {
      if (this.currentTabIndex === 0) {
        // Проверяем заполнены ли обязательные поля для первой вкладки
        if (!this.firstName || !this.lastName || !this.birthDate || !this.phoneNumber) {
          this.bioError = "All fields are required!";
          return false;  // Не позволяет перейти к следующей вкладке
        }
      }
      return true;
    },
    wizardCompleted() {
      // По завершению регистрации добавляем игрока в таблицу
      ...
      const newPlayer = {
        ...
        rating: 2500,  // Рейтинг по умолчанию
      };
        ...
        >
          ...
          <div class="step-content" v-if="currentTabIndex === 0">
            <div class="form-group">
              ...
              <input class="form-control" type="text" v-model="firstName" placeholder="Taras" required />
            </div>
            <div class="form-group">
              <label>Last Name</label>
              <input class="form-control" type="text" v-model="lastName" placeholder="Shevchenko" required />
            </div>
            <div class="form-group">
              <label>Birth Date</label>
              <input class="form-control" type="date" v-model="birthDate" required />
            </div>
            <div class="form-group">
              <label>Phone Number</label>
              <input class="form-control" type="tel" v-model="phoneNumber" placeholder="+380444618061" required />
            </div>
          ...
          <div class="step-content" v-if="currentTabIndex === 2">
            ...
            <div class="form-group">
              <label for="Privacy Policy" class="fw-medium">
